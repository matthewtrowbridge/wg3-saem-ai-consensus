...
window.WG3 = {
 themes: [
  ...
  {code:"T1a", name:"Documentation of AI", cluster:"Communicating",
  ...
  {code:"T1b", name:"Risks/benefits with patients", cluster:"Communicating",
  ...
  {code:"T2a", name:"When AI is beneficial", cluster:"Use cases",
   def:"Recognizing the clinical situations, populations, and workflows where a given AI tool adds value."},
  {code:"T2b", name:"Limitations & weaknesses", cluster:"Use cases",
  ...
  {code:"T2c", name:"Under-the-hood mechanisms", cluster:"Use cases",
